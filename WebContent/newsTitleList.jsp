...
<header>
	...
	<div id="page-content" class="archive-page container">
		<div class="">
			<div class="row">
			<div id="main-content" class="col-md-8" style="position:relative;width:85%;left:7%;height:100px">
<%
					...
					if (b == 0)
					{
						%>
						<div class="box">
					<div class="wrap-vid" style="height:80%">
					<center>
						<p>抱歉,相关新闻为空!</p>
						</center>
					</div>
				...
				<%
					...
					else
					{
						for (int i = 0;i < b;i++)
						{
							...
							%>
							<div class="box">
								<a href="showBody.action?url=<%=url %>"><h2 class="vid-name"><%=name%></h2></a>	
							<div class="wrap-vid">
